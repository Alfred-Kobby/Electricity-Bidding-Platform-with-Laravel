    ...
    -->
      <div class="sidebar-wrapper">
         <div class="logo">
          ...
          <a href="/producer" class="simple-text logo-normal">
            Dashboard
         ...
         <ul class="nav">
          <li>
            <a href="/bid/create">
              ...
              <p>Bidding Interface</p>
            </a>
          </li>
          <li>
            <a href="/producer/show_producer">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                ...
                <ul class="dropdown-menu dropdown-menu-right dropdown-navbar">
                 @foreach ($message as $messages)
                  <li class="nav-link">
                    <a href="{{url('/messages/producer_messages/show/' .$messages->message_id)}}" class="nav-item dropdown-item">
              ...
              <li class="dropdown nav-item">
                ...
                <ul class="dropdown-menu dropdown-navbar">
                  <li class="nav-link">
                    <a href="{{url('/producer_user/user_edit/' .$user_edit)}}" class="nav-item dropdown-item">Profile</a>
                  </li>
          ...
          <div class="login-box-body">
            <div class="form-group">
              ...
              <div class="form-group has-feedback">
                ...
                <!-- text -->
                <div class="form-group has-feedback">
                  <input class="form-control" name = "message" placeholder="Message" id="message" type="text"  required/> 
