...
<body class="">
      ...
      @include ('layouts.errors')
        ...
        <div class="row">
              ...
              <div class="card-header ">
                <div class="row">
                  <div class="col-sm-6 text-left">
                    ...
                    <h2 class="card-title">Current Dispatch</h2>
                    <br><br><br>
                  </div>
          ...
          <div class="col-md-6">
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title"> Current Dispatch</h4>
              </div>
              <div class="card-body">
          ...
          <div class="col-12">
            <div class="card card-chart">
              <div class="card-header ">
                <div class="row">
                  <div class="col-sm-6 text-left">
                    <h5 class="card-category">Dispatch</h5>
                    <h2 class="card-title">Your Dispatch</h2>
                  </div>
  ...
  @include('producer.partials.footer')
</body>
