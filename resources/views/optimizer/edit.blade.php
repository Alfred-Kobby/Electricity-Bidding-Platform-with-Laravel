          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
               ...
               <h2>Optimizer<a href="{{ URL::to('https://192.168.42.239') }}" class="pull-right btn btn-primary">Perform Optimiztion</a></h2>
               <hr>
               ...
               <div class="panel panel-default">
                ...
                <h3 class="card-title">
                  ...
                  <div class="panel-heading">Edit Reserved Capacity Form</div>
                 <hr>
