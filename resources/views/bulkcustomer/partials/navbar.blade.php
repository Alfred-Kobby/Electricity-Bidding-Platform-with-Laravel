    ...
    -->
      <div class="sidebar-wrapper">
         <div class="logo">
          ...
          <a href="/bulkcustomer" class="simple-text logo-normal">
            Dashboard
        ...
        <ul class="nav">
          ...
          <li>
            <a href="/bulkcustomer/show_bulkcustomer">
              <i class="tim-icons icon-istanbul"></i>
              <p>Market Rules</p>
            </a>
          </li>
          <li>
            <a href="/actual_demand/create">
              <i class="tim-icons icon-chart-bar-32"></i>
              <p>Actual Load demand</p>
            </a>
          </li>
          <li>
            <a href="/demand/create">
              <i class="tim-icons icon-chart-bar-32"></i>
              <p>Forecast Load demand</p>
            </a>
          </li>
          <li>
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                ...
                <ul class="dropdown-menu dropdown-menu-right dropdown-navbar">
                 @foreach ($message as $messages)
                  <li class="nav-link">
                    <a href="{{url('/messages/bulkcustomer_messages/show/' .$messages->message_id)}}" class="nav-item dropdown-item">
              ...
              <li class="dropdown nav-item">
                ...
                <ul class="dropdown-menu dropdown-navbar">
                  <li class="nav-link">
                    <a href="{{url('/bulkcustomer_user/user_edit/' .$user_edit)}}" class="nav-item dropdown-item">Profile</a>
                  </li>
