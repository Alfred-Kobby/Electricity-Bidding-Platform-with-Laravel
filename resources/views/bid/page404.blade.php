...
<body class="">
      ...
      <div class="content">
         ...
         <div class="row">
          ...
          ?> 
                <center><h2 class="pull-center">Bidding Interface</h2>
               <hr></center>
    
               <br>
               <h3>Bidding is Closed</h3>
               <h3>{{$bid_time}}, next bidding activities begin</h3>
               <h4>Time to bidding : {{$bid_time_left}}</h4>
 ...
 <!--  Google Maps Plugin    -->
  ...
  <script src="{{asset('css/assets/demo/producer.js')}}"></script>
  <script>
