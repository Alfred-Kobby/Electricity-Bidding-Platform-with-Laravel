...
class PowerDemandController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('demand.create', compact('user_log_name1','user_log_name2','user_edit', 'count', 'message'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $compare = PowerDemand::Where('created_at', 'like', $time.'%')->Where('customer_id', $cus_id)->count();
        
        if($compare)
        {
           return redirect('/demand/create')->with('error', 'Forecast Power Demand has already been submitted'); 
        }
        ...
        $demand->total_demand = $demand->_1 + $demand->_2 + $demand->_3 + $demand->_4 + $demand->_5 + $demand->_6 +
        ...
        $demand->save();
         ...
         return redirect('/demand/create')->with('success', 'Successfully added');
    }

    /**
     * Display the specified resource.
     *
     * @param  \App\PowerDemand  $powerDemand
     * @return \Illuminate\Http\Response
     */
    public function show(PowerDemand $powerDemand, $id )
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(PowerDemand $powerDemand)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, PowerDemand $powerDemand)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(PowerDemand $powerDemand)
    {
        //
    }
}
